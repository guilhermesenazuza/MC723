...
if [ -z "$BINUTILS_PATH" ]; then
  BINUTILS_PATH=`grep BINUTILS_PATH /home/ec2014/ra033324/y4k/classes/mc723a/projeto2/MC723/projeto2/sim/archc/etc/archc.conf | cut -d = -f2`
...
mkdir -p $TEMP_DIR
[ $? -ne 0 ] && exit $?
cp -rf /home/ec2014/ra033324/y4k/classes/mc723a/projeto2/MC723/projeto2/sim/archc/share/archc/binutils ${TEMP_DIR}/


# generate the files in the binutils tree
echo "Generating machine dependent code..."
/home/ec2014/ra033324/y4k/classes/mc723a/projeto2/MC723/projeto2/sim/archc/bin/bmdsfg $MODEL_FILE -a${ARCH_NAME}
[ $? -ne 0 ] && exit $?
...
if [ -z "$GDB_PATH" ]; then
  GDB_PATH=`grep GDB_PATH /home/ec2014/ra033324/y4k/classes/mc723a/projeto2/MC723/projeto2/sim/archc/etc/archc.conf | cut -d = -f2`
...
mkdir -p $TEMP_DIR
[ $? -ne 0 ] && exit $?
cp -rf /home/ec2014/ra033324/y4k/classes/mc723a/projeto2/MC723/projeto2/sim/archc/share/archc/gdb ${TEMP_DIR}/
